 ...
 * - WhileLoopActionUsage / ForLoopActionUsage / LoopActionUsage ->
 * Merge+Decision+body
        ...
        while (iterator.hasNext()) {
            ...
            if (obj instanceof org.omg.sysml.lang.sysml.Element) {
                ...
                if (id != null) {
                    ...
                    if ("WhileLoopActionUsage".equals(className) || "ForLoopActionUsage".equals(className)
                            || "LoopActionUsage".equals(className)) {
                        EObject nlParent = obj.eContainer();
                        boolean skipNestedLoop = false;
                        while (nlParent != null) {
                            String nlpc = nlParent.eClass().getName();
                            if ("WhileLoopActionUsage".equals(nlpc) || "ForLoopActionUsage".equals(nlpc)
                                    || "LoopActionUsage".equals(nlpc)) {
                                skipNestedLoop = true;
                                break;
                            }
                    ...
                    if (className.contains("IfActionUsage")) {
                        ...
                        if (conditionText == null || conditionText.isEmpty()) {
                            try {
                                String text = Files
                                        .readString(Paths.get(ctx.sysmlBasePath.replace(".sysmlx", ".sysml")));
                                Matcher m = Pattern.compile("if\\s+([^\\{]+)\\s*\\{").matcher(text);
                                int matchIdx = 0;
                                while (m.find()) {
                                    if (matchIdx == ctx.consumedIfRegexCount) {
                                        conditionText = m.group(1).trim();
                                        debugInfo.append("Used .sysml regex (pos=").append(ctx.consumedIfRegexCount)
                                                .append("): ").append(conditionText).append("\n");
                                        break;
                                    }
                                    matchIdx++;
                                }
                        ...
                        DecisionNode decision = (DecisionNode) ctx.activity.createOwnedNode(decisionName,
                        ...
                        for (int pmIdx = 1; pmIdx < paramMemberships.size(); pmIdx++) {
                            ...
                            for (EObject gc : pm.eContents()) {
                                ...
                                if (gcClass.contains("IfActionUsage")) {
                                    ...
                                    branchCount++;
                                } else if (gcClass.contains("ActionUsage")
                                        || gcClass.contains("AssignmentActionUsage")) {
                                    ...
                                    if (nestedIfInBranch != null) {
                                        ...
                                        String nestedIfId = ((org.omg.sysml.lang.sysml.Element) nestedIfInBranch)
                                                .getElementId();
                                        ...
                                        if (gcName != null && !gcName.isEmpty()) {
                                            ...
                                            nodeName = ExpressionUtils.sanitizeName(gcClass) + "_"
                                                    + gcId.substring(0, 8);
                                            bodyText = null;
                                        }
                                        ...
                                        if (bodyText != null && !bodyText.isEmpty() && bodyText.contains("=")) {
                                            branchNode = UmlHelper.createOpaqueActionForAssignment(ctx.activity,
                                                    nodeName, bodyText);
                                        } else {
                                            branchNode = UmlHelper.createCallBehaviorActionWithBody(ctx.activity,
                                                    nodeName, bodyText, "SysMLv2");
                                        }
                        ...
                        if (hasNestedIf) {
                            for (int pmIdx2 = 1; pmIdx2 < paramMemberships.size(); pmIdx2++) {
                                ...
                                for (EObject gc2 : pm2.eContents()) {
                                    if (!(gc2 instanceof org.omg.sysml.lang.sysml.Element))
                                        continue;
                                    if (gc2.eClass().getName().contains("IfActionUsage")) {
                                        String nestedMergeId = ((org.omg.sysml.lang.sysml.Element) gc2).getElementId()
                                                + "_ifMerge";
                    ...
                    // 解析循环结构 (LoopActionUsage) -- 用 equals 避免匹配 WhileLoopActionUsage
                    else if ("LoopActionUsage".equals(className)) {
                                    ...
                                    for (java.util.Iterator<EObject> deepIt = child.eAllContents(); deepIt.hasNext();) {
                                        ...
                                        if (deepCn.contains("Expression") && condText == null) {
                                            ...
                                            if (deep instanceof org.omg.sysml.lang.sysml.Element) {
                                                String refName = ((org.omg.sysml.lang.sysml.Element) deep)
                                                        .getDeclaredName();
                                    ...
                                    for (EObject ore : child.eContents()) {
                                        ...
                                        if ("ForLoopActionUsage".equals(oreCn) || "WhileLoopActionUsage".equals(oreCn)
                                            ...
                                            if ("ForLoopActionUsage".equals(oreCn))
                                                res = LoopExpander.expandNestedForLoop(ctx.activity, ore,
                                                        ctx.sysmlBasePath);
                                            else if ("WhileLoopActionUsage".equals(oreCn))
                                                res = LoopExpander.expandNestedWhileLoop(ctx.activity, ore,
                                                        ctx.sysmlBasePath);
                                            else
                                                res = LoopExpander.expandNestedLoopAction(ctx.activity, ore,
                                                        ctx.sysmlBasePath);
                                            ...
                                            for (EObject inner : ore.eContents()) {
                                                ...
                                                if ("ForLoopActionUsage".equals(innerCn)
                                                        || "WhileLoopActionUsage".equals(innerCn)
                                            ...
                                            if (nestedLoop != null) {
                                                ...
                                                if ("ForLoopActionUsage".equals(nc))
                                                    res = LoopExpander.expandNestedForLoop(ctx.activity, nestedLoop,
                                                            ctx.sysmlBasePath);
                                                ...
                                                bodyActions.add(res[0]);
                                                MainRunner.logicalEdges.add(new MainRunner.EdgeData(mergeId, res[0]));
                                                for (java.util.Iterator<EObject> it = nestedLoop.eAllContents(); it
                                                        .hasNext();) {
                                                    EObject d = it.next();
                                                    if (d instanceof org.omg.sysml.lang.sysml.Element) {
                                                        String dId = ((org.omg.sysml.lang.sysml.Element) d)
                                                                .getElementId();
                                                        if (dId != null) {
                                                            MainRunner.loopBodyNodeIds.add(dId);
                                                        }
                        ...
                        if (bodyActions.isEmpty()) {
                            for (EObject child : obj.eContents()) {
                                if (child.eClass().getName().contains("ActionUsage")
                                        || child.eClass().getName().contains("ReferenceUsage")) {
                    ...
                    // 解析 ForLoopActionUsage -> 展开为循环结构 (Merge->Body->Decision)
                    else if ("ForLoopActionUsage".equals(className)) {
                        String mergeId = id + "_forLoopMerge";
                        String decisionId = id + "_forLoopDecision";
                        String loopName = (name != null ? name : "ForLoop");
                        MergeNode merge = (MergeNode) ctx.activity.createOwnedNode(loopName + "_Merge",
                                UMLPackage.Literals.MERGE_NODE);
                        DecisionNode decision = (DecisionNode) ctx.activity.createOwnedNode(loopName + "_Decision",
                                UMLPackage.Literals.DECISION_NODE);
                        MainRunner.umlNodes.put(mergeId, merge);
                        MainRunner.umlNodes.put(decisionId, decision);
                        MainRunner.loopStartMerge.put(id, mergeId);
                                            ...
                                            if (gg.eClass().getName().contains("FeatureValue")) {
                                                for (EObject expr : gg.eContents()) {
                                                    if (expr.eClass().getName().contains("OperatorExpression")) {
                                                        String op = null;
                                                        try {
                                                            var opFeat = expr.eClass()
                                                                    .getEStructuralFeature("operator");
                                                            if (opFeat != null) {
                                                        ...
                                                        for (java.util.Iterator<EObject> lit = expr.eAllContents(); lit
                                                                .hasNext();) {
                                                            EObject litObj = lit.next();
                                                            if (litObj.eClass().getName().contains("LiteralInteger")) {
                                                                try {
                                                                    var valFeat = litObj.eClass()
                            ...
                            if (dc.eClass().getName().contains("ParameterMembership")) {
                                ...
                                if (pmCount == 2) { // 第2个 PM 是循环体
                                    for (EObject gc : dc.eContents()) {
                                        ...
                                        if (gcClass.contains("ActionUsage")
                                                || gcClass.contains("AssignmentActionUsage")) {
                                            EObject nestedLoop = null;
                                            ...
                                            if (!expr.isEmpty()) {
                                                ...
                                                nodeName = "ForLoopBody_"
                                                        + gcId.substring(0, Math.min(8, gcId.length()));
                                                bodyText = "forLoopBody";
                                            }
                                            ActivityNode bodyNode;
                                            if (!expr.isEmpty() && expr.contains("=")) {
                                                bodyNode = UmlHelper.createOpaqueActionForAssignment(ctx.activity,
                                                        nodeName, expr);
                                            } else {
                                                bodyNode = UmlHelper.createCallBehaviorActionWithBody(ctx.activity,
                                                        nodeName, bodyText, "SysMLv2");
                                            }
                        ...
                        if (bodyActionId != null
                                && !MainRunner.logicalEdges.stream().anyMatch(e -> e.source.equals(mergeId))) {
                        ...
                        System.out.println("[FOR-LOOP] id=" + id.substring(0, Math.min(8, id.length())) + " var="
                                + loopVarName + " range=" + rangeText + " body="
                                + (bodyActionId != null
                                        ? bodyActionId.substring(0, Math.min(8, bodyActionId.length()))
                                        : "null"));
                    }
                    // 解析 WhileLoopActionUsage -> 展开
                    else if ("WhileLoopActionUsage".equals(className)) {
                        ...
                        MergeNode merge = (MergeNode) ctx.activity.createOwnedNode(mergeName,
                                UMLPackage.Literals.MERGE_NODE);
                        MainRunner.umlNodes.put(mergeId, merge);
                        ...
                        DecisionNode untilDecision = (DecisionNode) ctx.activity.createOwnedNode(untilDecName,
                                UMLPackage.Literals.DECISION_NODE);
                        ...
                        for (EObject ba : bodyElements) {
                            ...
                            if ("IfActionUsage".equals(baClass)) {
                                ...
                                DecisionNode ifDecision = (DecisionNode) ctx.activity.createOwnedNode(ifDecName,
                                        UMLPackage.Literals.DECISION_NODE);
                            ...
                            if ("WhileLoopActionUsage".equals(baClass) || "ForLoopActionUsage".equals(baClass)
                                    || "LoopActionUsage".equals(baClass)) {
                                String[] res;
                            ...
                            if (baClass.contains("ActionUsage") && baName != null && !baName.isEmpty()) {
                                ...
                                try {
                                    ...
                                    if (feat == null)
                                        feat = ba.eClass().getEStructuralFeature("typed");
                                    if (feat == null)
                                        feat = ba.eClass().getEStructuralFeature("referencedType");
                                    if (feat != null) {
                            ...
                            if (bodyNode == null) {
                                ...
                                if (bodyText != null && !bodyText.isEmpty() && bodyText.contains("=")) {
                                    bodyNode = UmlHelper.createOpaqueActionForAssignment(ctx.activity, nodeName,
                                            bodyText);
                                } else {
                                    bodyNode = UmlHelper.createCallBehaviorActionWithBody(ctx.activity, nodeName,
                                            bodyText, "SysMLv2");
                                }
                            }
                        ...
                        if (isUntil) {
                            ...
                            if (!bodyNodeIds.isEmpty()) {
                                ...
                                // body 内部顺序流 (含 if 结构)
                                LoopExpander.buildBodyInternalFlows(ctx.activity, bodyNodeIds, ifDecisionIds,
                                        ifMergeIds, ifConditionTexts, ifThenBranchIds, MainRunner.umlNodes, merge,
                                        untilDecision);
                        ...
                        for (EObject child : obj.eContents()) {
                            if (child.eClass().getName().contains("FeatureValue")) {
                                for (EObject val : child.eContents()) {
                                    if (val.eClass().getName().contains("OperatorExpression"))
                                        hasAssignment = true;
                                }
                            }
                        }
                        if (hasAssignment && name != null) {
                            CallBehaviorAction assignAct = UmlHelper.createCallBehaviorAction(ctx.activity,
                                    "Assign_" + name);
                            MainRunner.umlNodes.put(id, assignAct);
                        }
                        // 非赋值 ReferenceUsage -> 判断是否为 decision/merge 占位符
                        else if (name != null && !name.isEmpty() && !ctx.existingNodeNames.contains(name)
                                && !ExpressionUtils.isControlKeyword(name)) {
                            ...
                            try {
                                ...
                                if (dirFeat != null) {
                                    ...
                                    if (dirVal instanceof String && !((String) dirVal).isEmpty())
                                        isParam = true;
                                }
                            } catch (Exception ignored) {
                                // ignored
                            ...
                            if (!isParam) {
                                ...
                                if (parent != null) {
                                    ...
                                    if (parentCn.contains("FeatureMembership"))
                                        isParam = true;
                                }
                            }
                            if (!isParam) {
                    ...
                    // 解析常规 Action (根据 typed 决定类型)
                    else if (className.contains("ActionUsage") && name != null && !name.isEmpty()
                            && !name.equals(ctx.activity.getName())) {
                        // 跳过 loop body wrapper (WhileLoopActionUsage 的 ParameterMembership 中的
                        // ActionUsage)
                        EObject parent = obj.eContainer();
                        ...
                        if (MainRunner.umlNodes.containsKey(id)) {
                            MainRunner.uuidToNameMap.put(id, name);
                            MainRunner.nameToIdMap.put(name, id);
                            if (name.startsWith("checkIf"))
                                lastCheckIfUuid = id;
                            continue;
                        }
                        // 跳过 Package 级别的 action 定义 (OwningMembership -> Package, 且无 FeatureMembership
                        // 子元素)
                        ...
                        // 只创建属于活动结构的顶层 actions
                        {
                            ...
                            // 例: monitorCriticalActivity -> performCriticalActivity(ActionUsage) ->
                            // MonitoredActivity(ActionDef) -> 跳过
                            // 反例: focus -> takePicture(ActionUsage) -> Package -> 不跳过 (takePicture 是主活动容器)
                            if (!skipThis) {
                                EObject anc2 = anc;
                                while (anc2 != null) {
                                    String anc2Cn = anc2.eClass().getName();
                                    if (anc2Cn.contains("ActionUsage") && !"ActionDefinition".equals(anc2Cn)) {
                                        if (anc2 instanceof org.omg.sysml.lang.sysml.Element) {
                                            String anc2Name = ((org.omg.sysml.lang.sysml.Element) anc2)
                                                    .getDeclaredName();
                                    ...
                                    if (anc2Cn.contains("ActionDefinition"))
                                        break;
                                    if (anc2Cn.contains("Package"))
                                        break;
                                    if (anc2Cn.contains("Definition")) {
                                        skipThis = true;
                                        break;
                                    }
                        ...
                        try {
                            ...
                            if (feat == null)
                                feat = obj.eClass().getEStructuralFeature("typed");
                            if (feat == null)
                                feat = obj.eClass().getEStructuralFeature("referencedType");
                            if (feat != null) {
                        ...
                        if (typedList != null && !typedList.isEmpty() && typedList.get(0) instanceof EObject) {
                            ...
                            if (typedClassName.contains("ActionDefinition")) {
                                ...
                                actionNode = ctx.activity.createOwnedNode(name,
                        ...
                        if (actionNode instanceof CallBehaviorAction) {
                            ...
                            for (EObject child : obj.eContents()) {
                                ...
                                for (EObject param : child.eContents()) {
                                    ...
                                    if (paramName == null || paramName.isEmpty() || direction == null
                                            || direction.isEmpty())
                                        continue;

                                    // 记录 feature elementId -> (actionId, paramName, direction) 供 BindingConnector
                                    // 解析
                                    try {
                                        String paramEid = ((org.omg.sysml.lang.sysml.Element) param).getElementId();
                                        if (paramEid != null) {
                                            ctx.featureIdToPinInfo.put(paramEid,
                                        ...
                                        for (EObject pc : param.eContents()) {
                                            if (pc.eClass().getName().equals("FeatureValue")) {
                                                ...
                                                if (srcRef != null && srcRef.length == 2) {
                                                    ctx.pinBindings
                                                            .add(new String[]{id, paramName, srcRef[0], srcRef[1]});
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    for (EObject pc3 : param.eContents()) {
                                        if (pc3.eClass().getName().equals("ReferenceSubsetting")) {
                                            ...
                                            if (lastChainingId != null) {
                                                ctx.featureIdToPinInfo.put(lastChainingId,
                                                        new String[]{id, paramName, direction});
                                            }
                                        }
                                    }
                                    ...
                                    if (typeDefId != null && ctx.actionSysmlElements.containsKey(typeDefId)) {
                                        ...
                                        for (EObject defChild : defObj.eContents()) {
                                            ...
                                            for (EObject defParam : defChild.eContents()) {
                                                ...
                                                if (!defParamCn.contains("ReferenceUsage")
                                                        && !defParamCn.contains("ItemUsage"))
                                                    continue;
                                                String defParamName = ((org.omg.sysml.lang.sysml.Element) defParam)
                                                        .getDeclaredName();
                                                String defDirection = ExpressionUtils.getFeatureString(defParam,
                                                        "direction");
                                                if (defParamName == null || defParamName.isEmpty()
                                                        || defDirection == null || defDirection.isEmpty())
                                                    continue;
                                                // 如果已有同名 pin, 跳过
                                                if (inPins.containsKey(defParamName)
                                                        || outPins.containsKey(defParamName))
                                                    continue;
                                                // 为继承参数创建 Pin
                                                if ("in".equals(defDirection)) {
                                                    InputPin pin = UMLFactory.eINSTANCE.createInputPin();
                                                    pin.setName(defParamName);
                                                    EStructuralFeature argFeat = cba.eClass()
                                                            .getEStructuralFeature("argument");
                                                    if (argFeat != null) {
                                                        @SuppressWarnings("unchecked")
                                                        java.util.List<Object> argList = (java.util.List<Object>) cba
                                                                .eGet(argFeat);
                                                        argList.add(pin);
                                                    }
                                                    inPins.put(defParamName, pin);
                                                    if (beh != null) {
                                                        org.eclipse.uml2.uml.Parameter bp = UMLFactory.eINSTANCE
                                                                .createParameter();
                                                        bp.setName(defParamName);
                                                        bp.setDirection(
                                                                org.eclipse.uml2.uml.ParameterDirectionKind.IN_LITERAL);
                                                        beh.getOwnedParameters().add(bp);
                                                    }
                                                    // 注册继承参数的 elementId
                                                    try {
                                                    ...
                                                    OutputPin pin = UMLFactory.eINSTANCE.createOutputPin();
                                                    pin.setName(defParamName);
                                                    EStructuralFeature resultFeat = cba.eClass()
                                                            .getEStructuralFeature("result");
                                                    if (resultFeat != null) {
                                                        @SuppressWarnings("unchecked")
                                                        java.util.List<Object> resultList = (java.util.List<Object>) cba
                                                                .eGet(resultFeat);
                                                    ...
                                                    if (beh != null) {
                                                        ...
                                                        bp.setName(defParamName);
                                                        bp.setDirection(
                                                                org.eclipse.uml2.uml.ParameterDirectionKind.OUT_LITERAL);
                                                        beh.getOwnedParameters().add(bp);
                                                    }
                                                    try {
                                                        String defParamEid = ((org.omg.sysml.lang.sysml.Element) defParam)
                    ...
                    // 显式 ForkNode 检测 (支持无名 ForkNode)
                        ...
                        ForkNode forkNode = (ForkNode) ctx.activity.createOwnedNode(forkName,
                    ...
                    // 显式 JoinNode 检测 (支持无名 JoinNode)
                        ...
                        JoinNode joinNode = (JoinNode) ctx.activity.createOwnedNode(joinName,
                        ...
                        boolean skipTerm = false;
                        {
                            ...
                            if (!skipTerm) {
                                ...
                                while (tAnc2 != null) {
                                    ...
                                    if (tAnc2Cn.contains("ActionUsage") && !"ActionDefinition".equals(tAnc2Cn)) {
                                        if (tAnc2 instanceof org.omg.sysml.lang.sysml.Element) {
                                            String tAnc2Name = ((org.omg.sysml.lang.sysml.Element) tAnc2)
                                                    .getDeclaredName();
                                    ...
                                    if (tAnc2Cn.contains("ActionDefinition"))
                                        break;
                                    if (tAnc2Cn.contains("Package"))
                                        break;
                                    if (tAnc2Cn.contains("Definition")) {
                                        skipTerm = true;
                                        break;
                                    }
                    ...
                    else if ("MergeNode".equals(className)) {
                        if (name != null && !name.isEmpty()) {
                            MergeNode mergeNode = (MergeNode) ctx.activity.createOwnedNode(name,
                                    UMLPackage.Literals.MERGE_NODE);
                    ...
                    // sysml:DecisionNode 检测 (decide 语法中的 DecisionNode, 无 declaredName)
                    else if ("DecisionNode".equals(className)) {
                        ...
                        if (ctx.decideConditionGroups.isEmpty()) {
                            try {
                                ...
                                for (int di = 0; di < decidePositions.size(); di++) {
                                    ...
                                    int blockEnd = (di + 1 < decidePositions.size())
                                            ? decidePositions.get(di + 1)
                                            : text.length();
                        ...
                        DecisionNode decisionNode = (DecisionNode) ctx.activity.createOwnedNode(decName,
                                UMLPackage.Literals.DECISION_NODE);
                    ...
                    // 结构: TransitionUsage -> TransitionFeatureMembership(kind=guard) ->
                    // OperatorExpression
                    ...
                    // 因此无法立即解析目标 ID, 需要延迟到 PASS 2c 解析
                    else if ("TransitionUsage".equals(className)) {
                        ...
                        // EndFeatureMembership -> ReferenceUsage -> ReferenceSubsetting ->
                        // referencedFeature
                        ...
                        for (EObject mChild : obj.eContents()) {
                            ...
                            if ("Membership".equals(mcn) && !mcn.contains("EndFeature") && !mcn.contains("Parameter")
                                    && !mcn.contains("Owning") && !mcn.contains("Transition")
                                    && !mcn.contains("Return")) {
                                try {
                        ...
                        if (transSrcId == null) {
                            ...
                            if (!ctx.allDecideDecisionIds.isEmpty() && !ctx.decideConditionGroups.isEmpty()) {
                                ...
                                for (int gi = 0; gi < ctx.decideConditionGroups.size(); gi++) {
                                    ...
                                    if (ctx.decideTransitionCount < count + groupSize
                                            && gi < ctx.allDecideDecisionIds.size()) {
                            ...
                            if (transSrcId == null)
                                transSrcId = ctx.lastDecideDecisionId;
                        }
                        ...
                        if (transSrcId != null && targetName != null) {
                            ...
                            if (condSuccTgtId != null && !MainRunner.nameToIdMap.containsKey(targetName)) {
                                ...
                                System.out.println("[DEBUG] TransitionUsage: registered nameToIdMap[" + targetName
                                        + "] = " + condSuccTgtId);
                            }
                    ...
                    // ReferenceSubsetting -> Feature -> FeatureChaining(actionPart) +
                    // FeatureChaining(pin)
                    // ========================================================
                    else if ("FlowUsage".equals(className)) {
                                                    ...
                                                    if (rsChild.eClass().getName().equals("Feature")) {
                                                        ...
                                                        for (EObject fc : rsChild.eContents()) {
                                                            if (fc.eClass().getName().equals("FeatureChaining")) {
                                                                try {
                                                                    var cfFeat = fc.eClass()
                                                                            .getEStructuralFeature("chainingFeature");
                                                                    if (cfFeat != null) {
                                                                        Object cfVal = fc.eGet(cfFeat);
                                                                        if (cfVal instanceof EObject) {
                                                                            cfVal = EcoreUtil.resolve((EObject) cfVal,
                                                                                    ctx.resourceSet);
                                                                            String cfName = null;
                                                                            if (cfVal instanceof org.omg.sysml.lang.sysml.Element) {
                                                                                cfName = ((org.omg.sysml.lang.sysml.Element) cfVal)
                                                                                        .getDeclaredName();
                                                                            }
                        ...
                        if (srcActionName == null || tgtActionName == null) {
                            try {
                                String text = Files
                                        .readString(Paths.get(ctx.sysmlBasePath.replace(".sysmlx", ".sysml")));
                                Matcher mFlow = Pattern.compile(
                                        "flow\\s+(?:of\\s+\\w+\\s+)?from\\s+(\\w+)\\.(\\w+)(?:\\.\\w+)*\\s+to\\s+(\\w+)\\.(\\w+)(?:\\.\\w+)*")
                                        .matcher(text);
                                int matchIdx = 0;
                                while (mFlow.find()) {
                        ...
                        // Record flow binding for DATA FLOW PASS (deferred - names may not be in
                        // nameToIdMap yet)
                        if (srcActionName != null && srcPinName != null && tgtActionName != null
                                && tgtPinName != null) {
                    ...
                    // ========================================================
                    else if ("SuccessionFlowUsage".equals(className)) {
                        String srcActionName = null, srcPinName = null;
                        String tgtActionName = null, tgtPinName = null;
                        int endCount = 0;
                        for (EObject fmChild : obj.eContents()) {
                            if (fmChild.eClass().getName().equals("EndFeatureMembership")) {
                                for (EObject fe : fmChild.eContents()) {
                                    if (fe.eClass().getName().equals("FlowEnd")) {
                                        // 1. Get action name from ReferenceSubsetting -> referencedFeature (direct
                                        // ActionUsage)
                                        for (EObject rs : fe.eContents()) {
                                            if (rs.eClass().getName().equals("ReferenceSubsetting")) {
                                                try {
                                                    ...
                                                    if (rfFeat != null) {
                                                        ...
                                                        if (rfVal instanceof EObject) {
                                                            ...
                                                            if (rfVal instanceof org.omg.sysml.lang.sysml.Element) {
                                                                String actionName = ((org.omg.sysml.lang.sysml.Element) rfVal)
                                                                        .getDeclaredName();
                                                                if (endCount == 0)
                                                                    srcActionName = actionName;
                                                                else
                                                                    tgtActionName = actionName;
                                                            }
                                                        }
                                                    }
                                                } catch (Exception ignored) {
                                        ...
                                        // 2. Get pin name from FeatureMembership -> ReferenceUsage -> Redefinition ->
                                        // redefinedFeature
                                                    ...
                                                    if (ru.eClass().getName().equals("ReferenceUsage")) {
                                                        for (EObject rd : ru.eContents()) {
                                                            if (rd.eClass().getName().equals("Redefinition")) {
                                                                try {
                                                                    var rdFeat = rd.eClass()
                                                                            .getEStructuralFeature("redefinedFeature");
                                                                    if (rdFeat != null) {
                                                                        Object rdVal = rd.eGet(rdFeat);
                                                                        if (rdVal instanceof EObject) {
                                                                            rdVal = EcoreUtil.resolve((EObject) rdVal,
                                                                                    ctx.resourceSet);
                                                                            if (rdVal instanceof org.omg.sysml.lang.sysml.Element) {
                                                                                String pinName = ((org.omg.sysml.lang.sysml.Element) rdVal)
                                                                                        .getDeclaredName();
                                                                                if (endCount == 0)
                                                                                    srcPinName = pinName;
                                                                                else
                        ...
                        if (srcActionName == null || tgtActionName == null) {
                            try {
                                String text = Files
                                        .readString(Paths.get(ctx.sysmlBasePath.replace(".sysmlx", ".sysml")));
                                Matcher mSF = Pattern.compile(
                                        "succession\\s+flow\\s+(?:of\\s+\\w+\\s+)?from\\s+(\\w+)\\.(\\w+)(?:\\.\\w+)*\\s+to\\s+(\\w+)\\.(\\w+)(?:\\.\\w+)*")
                                        .matcher(text);
                                while (mSF.find()) {
                        ...
                        if (srcActionName != null && srcPinName != null && tgtActionName != null
                                && tgtPinName != null) {
                            ctx.deferredSuccessionFlows
                                    .add(new String[]{srcActionName, srcPinName, tgtActionName, tgtPinName});
                        }
                        ctx.processedStructuralIds.add(id);
                        System.out.println("[DEBUG] SuccessionFlowUsage: " + srcActionName + "." + srcPinName + " -> "
                                + tgtActionName + "." + tgtPinName);
                    }
                    // ========================================================
                    ...
                    // ========================================================
                        ...
                        String structName = (name != null && !name.isEmpty())
                                ? name
                                : className + "_" + id.substring(0, Math.min(6, id.length()));
                        ...
                        if (className.contains("Action") || className.contains("Control")
                                ...
                                || className.contains("Flow") || className.contains("EventOccurrence")
                        ...
                        // PartDefinition -> UML Class
                                ...
                                || "OccurrenceDefinition".equals(className) || "ConnectionDefinition".equals(className)
                                || "InterfaceDefinition".equals(className) || "AllocationDefinition".equals(className)
                                || "FlowDefinition".equals(className) || "RequirementDefinition".equals(className)
                                || "ConcernDefinition".equals(className) || "ViewDefinition".equals(className)
                                || "RenderingDefinition".equals(className) || "UseCaseDefinition".equals(className)
                                || "VerificationCaseDefinition".equals(className)
                                || "AnalysisCaseDefinition".equals(className) || "CaseDefinition".equals(className)
                                || "MetadataDefinition".equals(className) || "PortDefinition".equals(className)
                                || "ConjugatedPortDefinition".equals(className)) {
                        ...
                        // StateDefinition -> UML StateMachine with States and Transitions
                                    ...
                                    for (EObject inner : child.eContents()) {
                                        ...
                                        // TransitionUsage -> record transition data
                                            ...
                                            for (EObject tc : inner.eContents()) {
                                                ...
                                                if ("Membership".equals(tcCn) && !tcCn.contains("End")
                                                        && !tcCn.contains("Parameter") && !tcCn.contains("Owning")) {
                                                    try {
                                                        var meFeat = tc.eClass().getEStructuralFeature("memberElement");
                                                        if (meFeat != null) {
                                                            Object meVal = tc.eGet(meFeat);
                                                            if (meVal instanceof EObject) {
                                                                srcStateId = ((org.omg.sysml.lang.sysml.Element) meVal)
                                                                        .getElementId();
                                                            }
                                                        }
                                                    } catch (Exception ignored) {
                                                        ...
                                                        for (EObject acu : tc.eContents()) {
                                                            if (acu.eClass().getName().equals("AcceptActionUsage")) {
                                                                for (EObject pm : acu.eContents()) {
                                                                    if (pm.eClass().getName()
                                                                            .equals("ParameterMembership")) {
                                                                        for (EObject ru : pm.eContents()) {
                                                                            if (ru.eClass().getName()
                                                                                    .contains("ReferenceUsage")) {
                                                                                for (EObject ft : ru.eContents()) {
                                                                                    if (ft.eClass().getName()
                                                                                            .equals("FeatureTyping")) {
                                                                                        try {
                                                ...
                                                if ("OwningMembership".equals(tcCn)) {
                                                    for (EObject succ : tc.eContents()) {
                                                        if (succ.eClass().getName().equals("SuccessionAsUsage")) {
                                                            int tEndIdx = 0;
                                                            for (EObject efm : succ.eContents()) {
                                                                if (efm.eClass().getName()
                                                                        .equals("EndFeatureMembership")) {
                                                                    if (tEndIdx == 1) { // second end = target
                                                                        for (EObject ref : efm.eContents()) {
                                                                            if (ref.eClass().getName()
                                                                                    .contains("ReferenceUsage")) {
                                                                                for (EObject rs : ref.eContents()) {
                                                                                    if (rs.eClass().getName().equals(
                                                                                            "ReferenceSubsetting")) {
                                                                                        try {
                                                                                            var rfFeat = rs.eClass()
                                                                                                    .getEStructuralFeature(
                                            ...
                                            if (srcStateId != null && tgtStateId != null) {
                                                stateTransitions
                                                        .add(new String[]{srcStateId, tgtStateId, triggerTypeName});
                                            }
                                        }
                                    }
                                }
                            ...
                            for (String[] trans : stateTransitions) {
                                ...
                                org.eclipse.uml2.uml.State srcState = srcName != null
                                        ? stateNameToUml.get(srcName)
                                        : null;
                                org.eclipse.uml2.uml.State tgtState = tgtName != null
                                        ? stateNameToUml.get(tgtName)
                                        : null;
                                if (srcState != null && tgtState != null) {
                                    ...
                                    if (triggerName != null && !triggerName.isEmpty()) {
                                        ...
                                        if (sig == null) {
                                            sig = (org.eclipse.uml2.uml.Signal) ctx.umlModel
                                                    .createPackagedElement(triggerName, UMLPackage.Literals.SIGNAL);
