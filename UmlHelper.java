...
class UmlHelper {
     ...
     */
    static CallBehaviorAction createCallBehaviorActionWithBody(Activity parentActivity, String nodeName, String body,
            String language) {
        // 1. 在父 Activity 上创建一个 OpaqueBehavior 作为行为定义
        String behaviorName = ExpressionUtils.capitalizeFirst(nodeName) + "Behavior";
        OpaqueBehavior behavior = (OpaqueBehavior) parentActivity.createOwnedBehavior(behaviorName,
        ...
        CallBehaviorAction cba = (CallBehaviorAction) parentActivity.createOwnedNode(nodeName,
    ...
    static ActivityNode createOpaqueActionForAssignment(Activity parentActivity, String nodeName, String assignExpr) {
        if (assignExpr != null && !assignExpr.isEmpty()) {
            ...
            OpaqueAction oa = (OpaqueAction) parentActivity.createOwnedNode(nodeName,
